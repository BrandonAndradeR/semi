...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Malware FET</title>
    <link rel="icon" href="https://fet.datasae.co/paquetes/modulo_preinscripcion/imagenes/logos/siga_fet_logo_encabezado.png" />
...
<main>
  ...
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <img src="https://maldita.es/uploads/public/202102/ALERTA_MALWARE.jpg" width="1700" height="500" />
      ...
      <img src="https://einatec.com/wp-content/uploads/2018/07/que-es-malware-tipos.jpg" width="1700" height="500" />
      ...
      <div class="carousel-item">
      <img src="https://cdn.vivomeunegocio.com.br/vivo-b2b/wp-content/uploads/2019/02/10181135/malware-e1660166393569-1024x647.jpg" width="1700" height="500"  />
  ...
  <div class="container marketing">
    ...
    <!-- -->
    <button id="open-chat" class="button-chat"> <i class="bi bi-chat"></i></button>

    <div id="chat-window">
        <div id="chat-header">Chat  
        <button id="close-chat" class="btnClo"><i class="bi bi-box-arrow-in-down-right"></i></button>
        </div>
